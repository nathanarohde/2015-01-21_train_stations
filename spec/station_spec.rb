...
describe(Station) do
  ...
  describe('#station_info') do
    it("lets you enter the information about a station") do
      test_station = Station.new({:station_info => "Tokyo", :line_id => 1, :station_id => 1})
 ...
 describe('#==') do
   it("is the same station as station info") do
    station1 = Station.new({:station_info => "Tokyo", :line_id => 1, :station_id => 1})
    station2 = Station.new({:station_info => "Tokyo", :line_id => 1, :station_id => 1})
  ...
  describe('#station_id') do
    it("lets you see the station id") do
      test_station = Station.new({:station_info => "Tokyo", :line_id => 1, :station_id => 2})
      expect(test_station.station_id()).to(eq(2))
    end
  end
